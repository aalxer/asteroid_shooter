...
function startGame() {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    // PARTICLE SYSTEM
    // Zur Erzeugung animierter Effekte im Spiel, wie Rauch- und Explosionseffekte. Jedes Partikelsystem
    // ist in einem separaten Modul implementiert, um sie unabhängig flexibel voneinander anzupassen.
